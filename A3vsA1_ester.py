...
for num in range(len(df_short_sorted['IC50'])):
	if df_short_sorted['Scaffold'][num] == 'S1' and (df_short_sorted['R5'][num] == 'CONH2' or df_short_sorted['R5'][num] == 'CONMe2'):
		#pass
		drop_list.append(num)

for num in range(len(df_short_sorted['IC50'])):
	if df_short_sorted['Scaffold'][num] == 'S2' and (df_short_sorted['R4'][num] == 'CONH2' or df_short_sorted['R4'][num] == 'CONMe2'):
		#pass
		drop_list.append(num)

for num in range(len(df_short_sorted['IC50'])):
	if df_short_sorted['Scaffold'][num] == 'S3' and (df_short_sorted['R4'][num] == 'CONH2' or df_short_sorted['R4'][num] == 'CONMe2'):
		#pass
		drop_list.append(num)
...
file_name = data_set_dict[cancer_cell_line_no][1]+' ester_plot.png'
